...
const members = [
    { name: 'Twilight', image: 'https://autods-scraper-images.s3-us-west-2.amazonaws.com/caea62a6fdd94834cb4673f3f9ea7640.png', bio: 'The film series tells the story of Bella Swan, a teenage girl who moves to the small town of Forks, Washington, and falls in love with Edward Cullen, a mysterious vampire. Their forbidden romance and the growing tension between the vampire coven (Cullens) and a local pack of werewolves (Jacob Black\'s pack) lead to escalating conflicts and supernatural dangers.' },
